...
<div class="row">
   ...
   <?php
	  ...
	  <div class="container-fluid">
		 ...
		 <form method="post">
		 <div class="col-sm-2" style="text-align:left;padding:10px; font-size:15px;"><button type="submit" name="addtocart" value="<?php echo $food_id; ?>")" ><span style="color:green;" <i class="fa fa-shopping-cart" aria-hidden="true"></i></span></button></div>
		 </form>
		 </div>
